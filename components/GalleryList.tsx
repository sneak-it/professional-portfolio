    ...
    <PageTransition>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        <div className="text-center mb-16">
          ...
          >
            A collection of my photography work organized by themes and projects.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {galleries.map((gallery, index) => (
            ...
            >
              <Link href={`/gallery/${gallery.slug}`} className="group block relative rounded-3xl overflow-hidden aspect-square bg-gray-100 dark:bg-gray-900">
                <Image
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                  ...
                  <p className="text-white/70 text-sm line-clamp-2">{gallery.description}</p>
                </div>
              </Link>
            </motion.div>
          ))}
